...
export default function SignupPage() {
  ...
  async function onSubmit({ displayName, email, password }) {
    ...
    try {
      ...
      toast.success('Account created! Welcome to GreenHeart 🌿');
      navigate('/subscribe');
    } catch (err) {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-20">
      <div className="absolute inset-0 bg-gradient-radial from-brand-900/15 to-transparent pointer-events-none" />
      ...
      >
        ...
        <div className="card border border-white/10">
          <h1 className="font-display text-2xl font-bold text-white text-center mb-1">Create your account</h1>
          <p className="text-white/40 text-sm text-center mb-8">Start playing for good today</p>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4">
            <div>
              <label className="text-white/60 text-xs font-medium mb-2 block">Full Name</label>
